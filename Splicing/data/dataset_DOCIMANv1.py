...
class DOCIMANv1(AbstractDatasetCls.AbstractDatasetCls):
    def __init__(self, crop_size, grid_crop, blocks: list, DCT_channels: int, tamp_list: str):
        ...
        self._root_path = project_config.dataset_paths['DOCIMANv1']
